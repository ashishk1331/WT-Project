...
export default function Edit() {
	const {
		...
		onSubmit: async function (values, actions) {
			let { firstName, lastName, rollno, branch } = values;

			console.log({ firstName, lastName, rollno, branch });
		},
	});
	...
	return (
		<div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
			<a
				href="/dashboard"
				className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 mb-4"
			>
				Go back
			</a>
			{/* Card */}
			<div className="bg-white rounded-xl shadow p-4 sm:p-7">
				<form onSubmit={handleSubmit}>
					...
					<div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200">
						<div className="text-center mb-8 col-span-12 mb-12">
